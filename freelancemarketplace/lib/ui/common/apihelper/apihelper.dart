...
const getoneprojectlink = "${url}getoneproject";

// booking
const registerbookinglink = "${url}registerbooking";
const allbookinglink = "${url}allbooking";
const statusbookingchangelink = "${url}statusbookingchange";
const deletebookinglink = "${url}deletebooking";
const updatebookinglink = "${url}updatebooking";
...
class ApiHelper {
  ...
  static Future<Map> getoneproject(String id) async {
    try {
      var response = await http.post(Uri.parse(getoneprojectlink),
          headers: {"Content-Type": "application/json"},
          body: jsonEncode({"id": id}));
      var data = jsonDecode(utf8.decode(response.bodyBytes));
      return data['data'];
  ...
  // booking
  static Future<bool> registerbooking(
      String uid, String pid, String ppid, BuildContext context) async {
    try {
  ...
  static Future<bool> statusbookingchange(String id) async {
    try {
      var response = await http.post(Uri.parse(statusbookingchangelink),
          headers: {"Content-Type": "application/json"},
  ...
  static Future<bool> deletebooking(String id) async {
    try {
      var response = await http.post(Uri.parse(deletebookinglink),
          headers: {"Content-Type": "application/json"},
          body: jsonEncode({"id": id}));
      var data = jsonDecode(utf8.decode(response.bodyBytes));
      return data['status'];
  ...
  static Future<bool> updatebooking(
      ...
      BuildContext context) async {
    try {
      var response = await http.post(Uri.parse(updatebookinglink),
          headers: {"Content-Type": "application/json"},
          body: jsonEncode({
            "id": id,
            "uid": uid,
  ...
  // cart
  static Future<bool> registercart(
      String uid, String pid, String ppid, BuildContext context) async {
    try {
